...
function NewPostPage() {
  ...
  try {
    const res = await apiRequest.post("/posts", {
      ...
      postDetails: {   // ✅ fixed name
        desc: value,
         utilities: inputs.utilities ? [inputs.utilities] : [],
    ...
    navigate("/posts/" + res.data._id);   // ✅ fixed id
        ...
        <div className="wrapper">
          <form onSubmit={handleSubmit}>
            ...
            <div className="item">
              ...
              <input min={1} id="bedrooms" name="bedrooms" type="number" />
            </div>
            <div className="item">
              <label htmlFor="bathrooms">Bathroom Number</label>
              <input min={1} id="bathrooms" name="bathrooms" type="number" />
            </div>
            <div className="item">
